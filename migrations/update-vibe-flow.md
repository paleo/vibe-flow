...
- [How to Write a Technical Specification.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/_docs/vibe-flow/How%20to%20Write%20a%20Technical%20Specification.md) → `_docs/vibe-flow/How to Write a Technical Specification.md`
- [How to Write Implementation Plans.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/_docs/vibe-flow/How%20to%20Write%20Implementation%20Plans.md) → `_docs/vibe-flow/How to Write Implementation Plans.md`
- [Discuss-Then-Do Protocol.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/_docs/vibe-flow/Discuss-Then-Do%20Protocol.md) → `_docs/vibe-flow/Discuss-Then-Do Protocol.md`
- [Vibe Flow Guide.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/_docs/vibe-flow/Vibe%20Flow%20Guide.md) → `_docs/vibe-flow/Vibe Flow Guide.md`
...
- If it **does not exist**:
  1. Fetch [this file](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/_docs/Writing%20Documentation.md) to `_docs/Writing Documentation.md` using `curl -o` or `wget -O`.
...
2. For each file below, check if it exists. If it does not exist, fetch it:
   - [spec.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/.claude/commands/spec.md) → `.claude/commands/spec.md`
   - [plan.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/.claude/commands/plan.md) → `.claude/commands/plan.md`
   - [dtdp.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/.claude/commands/dtdp.md) → `.claude/commands/dtdp.md`
   - [doc.md](https://raw.githubusercontent.com/paleo/vibe-flow/refs/heads/v1/.claude/commands/doc.md) → `.claude/commands/doc.md`
